...
public class GamePanel extends JPanel implements Runnable{
        ...
        if(promotion) {
            ...
            if(mouse.pressed) { 
                if(activeP == null) {
                    ...
                    // If the active piece is null, check if you can grab a piece
                    for(Piece piece : simPieces) {

                        // If the mouse is on an ally piece, grab it as the active piece
            ...
            if(mouse.pressed == false) {
                ...
                if(activeP != null) {
                    ...
                    if(validSquare) {
                        ...
                        // Update the piece list for captures during the simulation
                        copyPieces(simPieces, pieces);
                        activeP.updatePosition();

                        // Update the castling piece's position
                        if(castlingP != null) {
                            castlingP.updatePosition();
                        }

                        // If it's checkmate, the game is over
    ...
    private void simulate() {
        ...
        if(activeP.canMove(activeP.col, activeP.row)) {
            ...
            // Show the castling during the simulation
            checkCastling();
    ...
    private boolean isCheckmate() {
        ...
        // If it can't move, check if another piece can block the attack
        else {
    ...
    private void promoting() {
        ...
        if(mouse.pressed) {
            ...
            // Check what piece we choose to promote to
    ...
    public void paintComponent(Graphics g) {
        ...
        if(stalemate) {
            ...
            g2.drawString("Stalemate, it's a draw!", 200, 420);
        }
    }
}
